        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' blob: https://firstchapterai-production.up.railway.app https://api.firstchapter.ai https://*.clerk.accounts.dev wss://*.clerk.accounts.dev https://*.supabase.co https://lumberjack.razorpay.com https://api.razorpay.com",
